...
const resources = {
  id: {
    translation: {
      ...
      // Case Form
      "case.new": "Buat Permintaan Baru",
      "case.tab.new": "Permintaan Baru",
      "case.tab.clone": "Tiru Permintaan Lama",
      "case.tab.wizard": "Bantuan (Wizard)",
      "case.step.basic": "Informasi Dasar",
      "case.step.review": "Tinjau & Kirim",
      "case.field.title": "Judul Permintaan",
      ...
      "case.btn.submit": "Ajukan Permintaan",
      
      // Case List
      "list.filter": "Filter Status",
      "list.search": "Cari Permintaan...",
      "list.sort": "Urutkan",
